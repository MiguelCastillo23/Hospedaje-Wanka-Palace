            ...
            <div class="card-body p-4">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control py-2" id="name" name="name" required autofocus>
                    </div>
                    <div class="mb-3">
                ...
                <div class="mt-3 text-center">
                    <a href="{{ route('login') }}" class="text-decoration-none login-link">¿Ya tienes una cuenta? Inicia sesión aquí</a>
                </div>
            </div>
        </div>
    </div>
